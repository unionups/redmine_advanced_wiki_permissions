module WikiControllerPatch
  def self.included(base)
    base.class_eval do
      ...
      alias_method :show_without_wiki_permissions,
                   :show unless method_defined? :show_without_wiki_permissions
      alias_method :edit_without_wiki_permissions,
                   :edit unless method_defined? :edit_without_wiki_permissions
      alias_method :update_without_wiki_permissions,
                   :update unless method_defined? :update_without_wiki_permissions
      alias_method :rename_without_wiki_permissions,
                   :rename unless method_defined? :rename_without_wiki_permissions
      alias_method :protect_without_wiki_permissions,
                   :protect unless method_defined? :protect_without_wiki_permissions
      alias_method :history_without_wiki_permissions,
                   :history unless method_defined? :history_without_wiki_permissions
      alias_method :destroy_without_wiki_permissions,
                   :destroy unless method_defined? :destroy_without_wiki_permissions
      alias_method :export_without_wiki_permissions,
                   :export unless method_defined? :export_without_wiki_permissions
      alias_method :load_pages_for_index_without_wiki_permissions,
                   :load_pages_for_index unless method_defined? :load_pages_for_index_without_wiki_permissions
      ...
      def rename
        if @project &&
          ...
          rename_without_wiki_permissions
        end
      end
      ...
      def destroy
        if @project &&
          ...
          destroy_without_wiki_permissions
        end
      end
      ...
      def export
        if @project &&
          ...
          export_without_wiki_permissions
        end
      end
      ...
      verify :method => :post, :only => :ignore_permissions, :redirect_to => { :action => :show }
    ...
    private
      def load_pages_for_index
        ...
        if @project.module_enabled?('redmine_advanced_wiki_permissions')
          ...
          load_pages_for_index_without_wiki_permissions
        end
      end
